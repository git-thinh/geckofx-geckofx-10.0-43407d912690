...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMHTMLParamElement.idl
// 
...
namespace Gecko
{
	...
	[Guid("ccffedb8-f234-474e-9af4-576eba766023")]
	public interface nsIDOMHTMLParamElement : nsIDOMHTMLElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetValueTypeAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aValueType);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetValueTypeAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aValueType);
	}
}
