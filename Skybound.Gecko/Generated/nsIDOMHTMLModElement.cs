...
namespace Gecko
{
	...
	[Guid("417626fa-191c-41e5-aed5-f6157b408e72")]
	public interface nsIDOMHTMLModElement : nsIDOMHTMLElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetDateTimeAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aDateTime);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetDateTimeAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aDateTime);
	}
}
