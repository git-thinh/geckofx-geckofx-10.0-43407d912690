...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMSVGTextContentElement.idl
// 
...
namespace Gecko
{
	...
	[Guid("7531a45b-5f5a-4b30-9fb0-87498a87d4b4")]
	public interface nsIDOMSVGTextContentElement : nsIDOMSVGElement
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedEnumeration GetLengthAdjustAttribute();
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGPoint GetStartPositionOfChar(uint charnum);
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGPoint GetEndPositionOfChar(uint charnum);
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGRect GetExtentOfChar(uint charnum);
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		int GetCharNumAtPosition([MarshalAs(UnmanagedType.Interface)] nsIDOMSVGPoint point);
