...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMHTMLTableElement.idl
// 
...
namespace Gecko
{
	...
	[Guid("bba4b8b2-d01c-4c9b-abc8-3df28d048e68")]
	public interface nsIDOMHTMLTableElement : nsIDOMHTMLElement
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMHTMLTableCaptionElement GetCaptionAttribute();
		
		/// <summary>
        /// Modified in DOM Level 2:
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetCaptionAttribute([MarshalAs(UnmanagedType.Interface)] nsIDOMHTMLTableCaptionElement aCaption);
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMHTMLTableSectionElement GetTHeadAttribute();
		
		/// <summary>
        /// Modified in DOM Level 2:
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetTHeadAttribute([MarshalAs(UnmanagedType.Interface)] nsIDOMHTMLTableSectionElement aTHead);
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMHTMLTableSectionElement GetTFootAttribute();
		
		/// <summary>
        /// Modified in DOM Level 2:
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetTFootAttribute([MarshalAs(UnmanagedType.Interface)] nsIDOMHTMLTableSectionElement aTFoot);
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMHTMLCollection GetRowsAttribute();
		
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMHTMLCollection GetTBodiesAttribute();
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetCellPaddingAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aCellPadding);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetCellPaddingAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aCellPadding);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetCellSpacingAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aCellSpacing);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetCellSpacingAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aCellSpacing);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetFrameAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aFrame);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFrameAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aFrame);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetRulesAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aRules);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetRulesAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aRules);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetSummaryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aSummary);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetSummaryAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aSummary);
