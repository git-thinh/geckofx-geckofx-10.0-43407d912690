...
namespace Gecko
{
	...
	/// <summary>nsIDOMXULLabelElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("856417d4-5a5b-404c-91ab-692fa2c0c64f")]
	public interface nsIDOMXULLabelElement : nsIDOMXULDescriptionElement
	{
		...
		/// <summary>Member GetControlAttribute </summary>
		/// <param name='aControl'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetControlAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aControl);
		
		/// <summary>Member SetControlAttribute </summary>
		/// <param name='aControl'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetControlAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aControl);
	}
}
