...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMSVGMaskElement.idl
// 
...
namespace Gecko
{
	...
	[Guid("be2bf834-d5b8-45be-9411-21e3c97052d6")]
	public interface nsIDOMSVGMaskElement : nsIDOMSVGElement
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedEnumeration GetMaskUnitsAttribute();
		
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedEnumeration GetMaskContentUnitsAttribute();
