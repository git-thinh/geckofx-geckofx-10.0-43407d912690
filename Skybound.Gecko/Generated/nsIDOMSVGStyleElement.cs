...
namespace Gecko
{
	...
	[Guid("b67e4d60-7780-414c-9ee7-30776d0233f2")]
	public interface nsIDOMSVGStyleElement : nsIDOMSVGElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetXmlspaceAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aXmlspace);
		
		/// <summary>Member SetXmlspaceAttribute </summary>
		/// <param name='aXmlspace'> </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetXmlspaceAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aXmlspace);
