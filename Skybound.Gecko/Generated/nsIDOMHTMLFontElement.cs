...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMHTMLFontElement.idl
// 
...
namespace Gecko
{
	...
	[Guid("8a205975-86cb-44db-b20e-df7f2d200580")]
	public interface nsIDOMHTMLFontElement : nsIDOMHTMLElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetFaceAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aFace);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFaceAttribute([MarshalAs(UnmanagedType.LPStruct)] nsAStringBase aFace);
