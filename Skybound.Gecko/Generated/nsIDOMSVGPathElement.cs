...
namespace Gecko
{
	...
	[Guid("906f82c7-c632-4b1f-9dfd-3905b9080935")]
	public interface nsIDOMSVGPathElement : nsIDOMSVGElement
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGPathSegArcAbs CreateSVGPathSegArcAbs(float x, float y, float r1, float r2, float angle, [MarshalAs(UnmanagedType.U1)] bool largeArcFlag, [MarshalAs(UnmanagedType.U1)] bool sweepFlag);
		
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGPathSegArcRel CreateSVGPathSegArcRel(float x, float y, float r1, float r2, float angle, [MarshalAs(UnmanagedType.U1)] bool largeArcFlag, [MarshalAs(UnmanagedType.U1)] bool sweepFlag);
