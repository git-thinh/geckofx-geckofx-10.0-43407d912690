...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMSVGTextPositionElem.idl
// 
...
namespace Gecko
{
	...
	/// <summary>nsIDOMSVGTextPositioningElement </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("cbafeadc-a004-4b07-b8e0-1a06e1841dcf")]
	public interface nsIDOMSVGTextPositioningElement : nsIDOMSVGTextContentElement
	{
		...
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedLengthList GetXAttribute();
		
		/// <summary>Member GetYAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedLengthList</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedLengthList GetYAttribute();
		
		/// <summary>Member GetDxAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedLengthList</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedLengthList GetDxAttribute();
		
		/// <summary>Member GetDyAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedLengthList</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedLengthList GetDyAttribute();
		
		/// <summary>Member GetRotateAttribute </summary>
		/// <returns>A nsIDOMSVGAnimatedNumberList</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIDOMSVGAnimatedNumberList GetRotateAttribute();
	}
}
