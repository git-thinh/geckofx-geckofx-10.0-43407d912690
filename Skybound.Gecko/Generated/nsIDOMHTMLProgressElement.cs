...
// 
// <remarks>
// Generated by IDLImporter from file nsIDOMHTMLProgressElement.idl
// 
...
namespace Gecko
{
	...
	[Guid("aa830aa2-a4ea-455e-8285-8344cadb4c6d")]
	public interface nsIDOMHTMLProgressElement : nsIDOMHTMLElement
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		double GetMaxAttribute();
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetMaxAttribute(double aMax);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		double GetPositionAttribute();
